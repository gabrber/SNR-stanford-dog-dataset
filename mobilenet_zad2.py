...
model_zad2 = load_model('models\\zad2_mobilenet.h5', custom_objects={'top5_acc': top5_acc})
...
print(model_zad2.metrics_names)
testing = model_zad2.evaluate_generator(test_generator,
                                        test_steps)
print(testing)
